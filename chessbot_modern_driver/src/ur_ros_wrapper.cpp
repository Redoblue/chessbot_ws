...
public:
    ...
    RosWrapper(std::string host, int reverse_port) :
        ...
        // RG2 gripper
        rg2_service = nh_.advertiseService<chessbot_control::RG2::Request, chessbot_control::RG2::Response>
                ("/rg2_gripper/control_width", boost::bind(&UrDriver::rg2Callback, &robot_, _1, _2));
        // RG2 Grip_Detect
        rg2_detect_service = nh_.advertiseService<chessbot_control::RG2_Grip::Request, chessbot_control::RG2_Grip::Response>
...
private:
    ...
    bool rg2GripDetectServer(chessbot_control::RG2_Grip::Request &req, chessbot_control::RG2_Grip::Response &res)
    {
        bool flag = false;
